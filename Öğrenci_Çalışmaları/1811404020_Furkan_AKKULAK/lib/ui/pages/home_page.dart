        ...
        frontLayer: ListView(
          ...
          children: [
            ...
            TextField(
              ...
              decoration:
                  const InputDecoration(labelText: 'Ne yapman gerekiyor?'),
              onSubmitted: (value) {
            ...
            Padding(
              ...
              child: Text(
                '${ref.watch(totalTodoCount).toString()} görev arasından ${ref.watch(uncompletedTodoCount).toString()} görev kaldı',
            ...
            if (todos.data.isEmpty) ...[
              ...
              const Text(
                'Hiç görev yok!\n Yeni bir tane eklemeyi deneyin.',
                textAlign: TextAlign.center,
              ),
            ],
