            ...
            return MaterialPageRoute<void>(
              ...
              builder: (BuildContext context) {
                switch (routeSettings.name) {
                  case PathologyReportFormPageWidget.routeName:
                    return PathologyReportFormPageWidget();
                  case PathologyReportScreenWidget.routeName:
                    return PathologyReportScreenWidget();
                  case SettingsView.routeName:
                    return SettingsView(controller: settingsController);
                  case AboutUsScreenWidget.routeName:
                    return const AboutUsScreenWidget();
                  case PathologyReportListPageWidget.routeName:
                  default:
                    return const PathologyReportListPageWidget();
                }
              },
            );
          },
