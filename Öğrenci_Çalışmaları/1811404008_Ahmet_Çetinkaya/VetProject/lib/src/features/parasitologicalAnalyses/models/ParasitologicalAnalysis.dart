...
class ParasitologicalAnalysis implements IJsonable {
  int? id;
  String? analysisId;
  int? statusId;
  String? parasitologicalAnalysis;
  int? assigneeUserId;
  ...
  ParasitologicalAnalysis(
      {this.id,
      this.analysisId,
      this.statusId,
      this.parasitologicalAnalysis,
      this.assigneeUserId,
  ...
  ParasitologicalAnalysis.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    analysisId = json['analysis_id'];
    statusId = json['status_id'];
    parasitologicalAnalysis = json['parasitological_analysis'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['parasitological_analysis'] = parasitologicalAnalysis;
