...
class MicroscopicDiagnosisListModel {
  int? currentPage;
  late List<MicroscopicDiagnosis> data;
  String? firstPageUrl;
  int? from;
  int? lastPage;
  String? lastPageUrl;
  ...
  MicroscopicDiagnosisListModel.fromJson(Map<String, dynamic> json) {
    currentPage = json['current_page'];
    if (json['data'] != null) {
      data = <MicroscopicDiagnosis>[];
      json['data'].forEach((v) {
        data.add(MicroscopicDiagnosis.fromJson(v));
      });
    }
