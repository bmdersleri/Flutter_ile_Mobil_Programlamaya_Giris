...
class MacroscopicDiagnosis {
  int? id;
  String? diagnosisId;
  int? statusId;
  String? macroscopicDiagnosis;
  int? filesCount;
  int? assigneeUserId;
  ...
  MacroscopicDiagnosis(
      {this.id,
      this.diagnosisId,
      this.statusId,
      this.macroscopicDiagnosis,
      this.filesCount,
      this.assigneeUserId,
  ...
  MacroscopicDiagnosis.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    diagnosisId = json['diagnosis_id'];
    statusId = json['status_id'];
    macroscopicDiagnosis = json['macroscopic_diagnosis'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['macroscopic_diagnosis'] = macroscopicDiagnosis;
