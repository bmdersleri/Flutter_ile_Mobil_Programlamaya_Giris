...
class MacroscopicDiagnosisListModel {
  int? currentPage;
  late List<MacroscopicDiagnosis> data;
  String? firstPageUrl;
  int? from;
  int? lastPage;
  String? lastPageUrl;
  ...
  MacroscopicDiagnosisListModel.fromJson(Map<String, dynamic> json) {
    currentPage = json['current_page'];
    if (json['data'] != null) {
      data = <MacroscopicDiagnosis>[];
      json['data'].forEach((v) {
        data.add(MacroscopicDiagnosis.fromJson(v));
      });
    }
