...
class OkumaYazma extends StatefulWidget {
  @override
  _OkumaYazmaState createState() => _OkumaYazmaState();
}
...
class _OkumaYazmaState extends State<OkumaYazma> {
  final Color accentColor = Colors.green;

  List<ItemModel> items = [
    ItemModel("Okuma Yazma"),
    ...
    return Row(
      ...
      children: <Widget>[
        ...
        Column(
          ...
          children: [
            IconButton(
              onPressed: () => Navigator.pushNamed(context, 'Yon'),
              icon: Icon(
                Icons.menu_open,
                color: Colors.grey,
                size: 20,
